      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          >
            ...
            <PopoverContent
              align="start"
              className="w-[var(--radix-popover-trigger-width)] min-w-[280px] overflow-hidden p-1"
            >
              {/* All option */}
              <label
                className={cn(
              ...
              <div className="max-h-64 overflow-x-hidden overflow-y-auto">
                {sourceOptions.length === 0 ? (
                  ...
                  sourceOptions.map((source) => {
                    ...
                    return (
                      <div key={source.id} className="group flex w-full min-w-0 items-center gap-1">
                        <label
                          className={cn(
                            "flex w-full min-w-0 flex-1 items-center gap-2 rounded-sm px-2 py-2 transition-colors cursor-pointer",
                            isSelected
                              ? "bg-foreground/10 text-foreground"
                              : "text-muted-foreground hover:text-foreground hover:bg-secondary",
                          )}
