  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-[var(--color-text-muted)]">Income</p>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative">
              ...
              <select
                ...
                className={cn(
                  'appearance-none pl-10 pr-10 py-2.5 rounded-xl',
                  'bg-[var(--color-bg-secondary)] border border-[var(--color-border)]',
      ...
      <Card>
        {/* Table Header */}
        <div className="hidden lg:flex items-center gap-4 px-5 py-3 border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)]">
          <div className="w-10" /> {/* Icon space */}
          <div className="flex-1 text-sm font-medium text-[var(--color-text-muted)]">
            Description
          </div>
          <button
            onClick={() => toggleSort('date')}
            className="flex items-center gap-1 text-sm font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] transition-colors w-28"
          >
            Date
            <ArrowUpDown className="w-3 h-3" />
          </button>
          <div className="text-sm font-medium text-[var(--color-text-muted)] w-28">
            Category
          </div>
          <button
            onClick={() => toggleSort('amount')}
            className="flex items-center gap-1 text-sm font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] transition-colors w-28 justify-end"
          >
            Amount
            <ArrowUpDown className="w-3 h-3" />
          </button>
...
function TransactionRow({ transaction }: { transaction: TransactionWithDetails }) {
  return (
    <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4 px-5 py-4 hover:bg-[var(--color-bg-hover)] transition-colors">
      <CategoryIcon
      ...
      <div className="hidden lg:flex lg:items-center lg:gap-4 lg:flex-1">
        ...
        <div className="w-28 text-sm text-[var(--color-text-secondary)]">
          {formatDate(transaction.date)}
        </div>
        <div className="w-28">
