    ...
    <div className="p-5 bg-surface rounded-(--radius-lg) transition-colors duration-150 hover:bg-surface-hover cursor-pointer">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-body font-medium text-text">{account.name}</div>
            <div className="text-ui text-text-muted capitalize">{account.type}</div>
          </div>
        </div>
        <div
          className={cn(
      ...
      {recentTransactions.length > 0 && (
        <div className="border-t border-border pt-3 mt-1">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-ui text-text-muted flex items-center gap-0.5 hover:text-text transition-colors cursor-pointer">
