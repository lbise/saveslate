  ...
  return (
    <Popover open onOpenChange={(open) => { if (!open) onClose(); }}>
      ...
      <PopoverContent
        side="bottom"
        align="end"
        className="w-80 max-w-[calc(100vw-2rem)] p-0 py-1"
        ...
        {selectedTagIds.length > 0 && (
          <div className="px-2 pb-1">
            <button
              type="button"
              onClick={() => onChange([])}
              className="w-full px-2 py-1.5 rounded-sm bg-transparent border-none cursor-pointer text-sm text-dimmed hover:text-foreground hover:bg-secondary transition-colors text-left flex items-center gap-2"
            >
              <X size={12} />
              Clear tags
            </button>
                    ...
                    {isPendingDelete ? (
                      ...
                      <>
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center rounded-sm bg-transparent border-none text-dimmed hover:text-foreground hover:bg-secondary cursor-pointer"
                        ...
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center rounded-sm bg-transparent border-none text-dimmed hover:text-expense hover:bg-expense/10 cursor-pointer"
